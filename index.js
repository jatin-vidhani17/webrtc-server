...
const socketToRoomMapping = new Map(); // Track socket-to-room mapping
...
io.on('connection', (socket) => {
    ...
    socket.on('join-room', (data) => {
        ...
        socketToRoomMapping.set(socket.id, roomId); // Store room ID
        socket.join(roomId);
    ...
    socket.on('call-user', (data) => {
        ...
        console.log(`Call from ${fromEmail} to ${emailId}:`, offer);
        if (socketId) {
    ...
    socket.on('call-accepted', (data) => {
        ...
        const socketId = emailToSocketMapping.get(emailId);
        console.log(`Call accepted by ${emailId}:`, ans);
        if (socketId) {
